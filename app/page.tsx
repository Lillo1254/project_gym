...
export default function Home() {
  ...
  return (
    <main className=" sm:pt-16">
      ...
      <section className="relative min-h-[90svh] md:min-h-screen grid grid-cols-1 md:grid-cols-2 items-center justify-center overflow-hidden py-30 md:py-20">
        ...
        <div className="w-full flex flex-col items-center text-center px-4 sm:px-6 md:px-8 z-10">
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-md sm:max-w-none">
            <Link href="/corsi" className="w-full sm:w-auto bg-secondary text-primary px-8 py-4 rounded-sm font-black hover:bg-quarto hover:scale-105 transition-all uppercase tracking-widest cursor-pointer">
              Scopri i nostri corsi
            </Link>
            <Link href="/contact" className="w-full sm:w-auto border border-quarto/30 text-quarto px-8 py-4 rounded-sm font-bold hover:bg-quarto hover:text-primary hover:scale-105 transition-all uppercase tracking-widest cursor-pointer">
              Prenota una lezione
            </Link>
          </div>
      ...
      <section className="min-h-50 flex flex-col md:flex-row gap-6 py-12 px-6 justify-evenly items-center overflow-hidden section_1_observer ">
        {/* Photo 1 */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 square_section_2">
            {[
              ...
              <div
                key={i}
                className="flex flex-col items-center justify-center p-6 sm:p-8 border border-quarto hover:border-secondary group text-center rounded-sm shadow-[0_0_10px_0px_var(--color-secondary)] hover:bg-secondary/30 hover:shadow-[0px_10px_10px_5px_var(--color-tertiary)] hover:scale-110 hover:-translate-y-3 transition-all group"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            ...
            <div className="bg-primary/80 h-75 md:h-112.5 w-full flex items-center justify-center overflow-hidden">
              <div className="relative w-full h-full flex items-center justify-center">
                <Image
                  src="/images/Screenshotversdestr1.svg"
                  alt="Scientific Training Image"
                  fill
                  className="object-contain"
                />
                <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-quarto uppercase tracking-[0.5em] font-bold text-center px-4 z-10">
                  Eleganza e Forza
                </span>
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-base md:text-lg text-quarto font-light mb-8 leading-relaxed text_cont_2">
              Non siamo una palestra tradizionale. Uniamo la passione per la ginnastica e lo sport a un metodo strutturato,
              per accompagnare ogni allievo dai primi passi fino alla definizione della tecnica avanzata e agonistica.
            </p>
            <ul className="space-y-4 ">
              {['Preparazione Tecnica Avanzata', 'Sviluppo Motorio e Inclusione', 'Percorsi per Ogni Età'].map((item, i) => (
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    {/* Gallery Grid */}
    <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 md:h-200">

      {/* Immagine Grande - Main Event */}
      <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden bg-quarto/10 border border-quarto/20 h-96 md:h-auto rounded-3xl">
        <div className="absolute inset-0 group group-hover:bg-transparent transition-colors duration-500 z-10" />
        <Image
          src="/images/gio_cuore.webp"
          alt="images generic for competitions gymnastics"
          fill
          sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
          className="object-cover sm:grayscale sm:brightness-125 sm:group-hover:grayscale-0 group-hover:scale-105 transition-all duration-700"
        />
      </div>
      ...
      <div className="md:col-span-2 md:row-span-1 relative group overflow-hidden bg-quarto/10 border border-quarto/20 h-75 md:h-auto rounded-3xl">
        <Image
          src="/images/scudettoFGI.png"
          alt="images generic for competitions gymnastics"
          fill
          sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
          className="object-contain sm:grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-700"
        />
      </div>
      ...
      <div className="md:col-span-1 md:row-span-1 relative group overflow-hidden bg-quarto/10 border border-quarto/20 h-75 md:h-auto rounded-3xl">
        <Image
          ...
          fill
          sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
          className="object-cover sm:grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-700"
        />
      </div>
      ...
      <div className="md:col-span-1 md:row-span-1 relative group overflow-hidden border border-secondary bg-secondary/10 flex items-center justify-center p-6 text-center h-75 md:h-auto rounded-3xl">
        <Image
          ...
          fill
          sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
          className="object-contain bg-white sm:grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-700 relative"
        />
        <div className="absolute inset-0 bg-primary/40 flex flex-col items-center justify-center p-6 z-20">
          <p className="text-quarto text-xs font-light uppercase tracking-tighter mb-4">
            Guarda le nostre <br />competizioni
          </p>
