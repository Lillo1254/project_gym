      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-20">
          <h1 className="text-6xl md:text-8xl font-black italic uppercase leading-none tracking-tighter">
            ENTRA NEL <span className="text-secondary">SISTEMA</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-quarto/20">
          ...
          <a href="mailto:info@tuodominio.it" 
            ...
            <h3 className="text-2xl font-black uppercase italic mb-4 group-hover:text-primary">Invia Email</h3>
          ...
          <a href="https://wa.me/391234567890" 
            ...
            <h3 className="text-2xl font-black uppercase italic mb-4 group-hover:text-primary">WhatsApp</h3>
            <p className="text-quarto group-hover:text-primary/80 mb-8 font-light">
          ...
          <a href="tel:+391234567890" 
            ...
            <h3 className="text-2xl font-black uppercase italic mb-4 group-hover:text-primary">Chiamata</h3>
            <p className="text-quarto group-hover:text-primary/80 mb-8 font-light">
        ...
        <div className="mt-20 flex flex-col md:flex-row justify-between items-end gap-8 border-t border-quarto/10 pt-10">
          <div>
            <span className="text-secondary font-black text-5xl italic opacity-20 uppercase select-none">
              Precision is not optional
            </span>
          </div>
          <div className="text-right">
            <p className="text-quarto/50 uppercase text-xs tracking-[0.2em] mb-2">Sede Centrale</p>
            <p className="text-quarto font-bold italic">Via della Forza 42, Hub Tecnologico</p>
          </div>
        </div>
