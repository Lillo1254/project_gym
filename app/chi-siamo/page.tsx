  ...
  return (
    <main className="pt-32 pb-24 bg-gradient-to-b from-primary to-tertiary">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-24">
        <h1 className="text-6xl text-secondary md:text-8xl font-black italic uppercase tracking-tighter mb-12">
          LA NOSTRA <span className="text-secondary brightness-125">FILOSOFIA</span>
        </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-24 ">
        <h2 className="text-4xl text-secondary md:text-6xl font-black uppercase tracking-tighter mb-16 italic">
          LE NOSTRE <span className="text-secondary brightness-125">ATTIVITÀ</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className=" bg_centri p-10 rounded-sm border-l-4 border-secondary flex flex-col justify-between">
            <div>
              <h3 className="text-2xl font-black uppercase mb-4 tracking-tight text-quarto">Centri Estivi</h3>
              <p className="text-quarto  font-light leading-relaxed mb-6">
            ...
            <a href="/corsi" className="text-quarto font-bold text-sm tracking-widest uppercase hover:underline">
              Scopri di più &rarr;
            </a>
          </div>
          ...
          <div className="bg_campi p-10 rounded-sm border-l-4 border-quarto flex flex-col justify-between">
            <div>
              <h3 className="text-2xl font-black uppercase mb-4 tracking-tight text-quarto">Campo Scuola Allenamento</h3>
              <p className="text-quarto font-light leading-relaxed mb-6">
            ...
            <a href="/contatti" className="text-quarto font-bold text-sm tracking-widest uppercase hover:underline">
          ...
          <div className="bg_istruttori p-10 rounded-sm border-l-4 border-secondary/50 flex flex-col justify-between ">
            <div>
              <h3 className="text-2xl font-black uppercase mb-4 tracking-tight text-quarto">Educatrici e Responsabili</h3>
              <p className="text-quarto font-light leading-relaxed mb-6">
